...
namespace KanchimeshAPI.Migrations
{
    ...
    [Migration("20260925083735_AddQuotations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KanchimeshAPI.Models.Expense", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("KanchimeshAPI.Models.ProductRawMaterial", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("KanchimeshAPI.Models.PurchasePayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("KanchimeshAPI.Models.Quotation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("KanchimeshAPI.Models.QuotationItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("KanchimeshAPI.Models.RawMaterial", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("AvailableStock")
                        ...
                        .HasPrecision(18, 3)
                        .HasColumnType("decimal(18,3)")
                        .HasComputedColumnSql("[TotalStock] - [UsedStock]");
            ...
            modelBuilder.Entity("KanchimeshAPI.Models.ProductRawMaterial", b =>
                {
                    ...
                    b.HasOne("KanchimeshAPI.Models.RawMaterial", "RawMaterial")
            ...
            modelBuilder.Entity("KanchimeshAPI.Models.PurchasePayment", b =>
                {
                    b.HasOne("KanchimeshAPI.Models.PurchaseRecord", "PurchaseRecord")
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("KanchimeshAPI.Models.Quotation", b =>
                {
                    b.HasOne("KanchimeshAPI.Models.SalesOrder", "ConvertedSalesOrder")
                        .WithMany()
            ...
            modelBuilder.Entity("KanchimeshAPI.Models.QuotationItem", b =>
                {
                    ...
                    b.HasOne("KanchimeshAPI.Models.Quotation", "Quotation")
                        .WithMany("Items")
